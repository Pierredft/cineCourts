 ...
 */
final class Version20240729133152 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE films ADD affiche VARCHAR(255) NOT NULL, ADD video_film VARCHAR(255) DEFAULT NULL, DROP updated_at');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE films ADD updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', DROP affiche, DROP video_film');
    }
}
